...
function addUser(req, res) {
    ...
    const new_user = { username: req.body.username, birthYear: req.body.birthYear, miscInfo: req.body.miscInfo };
    //console.log(new_user);
    if (users.some(user => user.username === new_user.username)) { //array.some: https://stackoverflow.com/a/8217584
